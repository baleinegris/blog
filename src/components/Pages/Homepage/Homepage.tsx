    ...
    return (
        ...
        <div className="flex flex-col items-left justify-center ml-8 w-[60%]">
            ...
            <div className='flex gap-2'>
                <a href="/posts" className="px-6 py-3 w-[30%] bg-gray-700 text-gray-100 rounded hover:bg-blue-600 transition">
                    View Posts
                </a>
                <a href="/projects" className="px-6 py-3 w-[30%] bg-gray-700 text-gray-100 rounded hover:bg-blue-600 transition">
                    View Projects
                </a>
            </div>
        </div>
